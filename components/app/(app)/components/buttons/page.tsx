        ...
        <div className="gap-2 flex flex-2/3 ml-20 mr-20 justify-between">
          ...
          <div className="rounded-xl w-100 h-100 mt-40 border border-solid border-white/30 bg-white p-1  shadow-input dark:bg-black md:rounded-2xl">
            <div className="rounded-xl w-fit border border-solid border-white/30 bg-white p-1 mt-40 ml-38 shadow-input justify-center items-center dark:bg-black md:rounded-2xl">
              <button
                className="group cursor-pointer relative block h-10 w-20 rounded-full bg-linear-to-br >
          ...
          <div className="rounded-xl w-100 h-100 mt-30 border border-solid border-white/30 bg-black p-1   shadow-input md:rounded-2xl">
            <div className="rounded-xl w-fit mt-40 ml-25 shadow-input justify-center items-center dark:bg-black md:rounded-2xl">
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                <button
                  type="button"
                  className="flex items-center gap-3 rounded-xl border border-zinc-200 bg-white px-5 py-3 text-sm font-medium text-zinc-700 shadow-sm transition-all duration-300 hover:scale-105 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100"
                >
                  <img
        ...
        <div className="gap-2 flex flex-2/3 ml-20 mb-20 mr-20 justify-between">
          ...
          <div className="rounded-xl w-100 h-100 mt-30 border border-solid border-white/30 bg-black p-1   shadow-input md:rounded-2xl">
            <div className="rounded-xl w-fit mt-40 ml-25 shadow-input justify-center items-center dark:bg-black md:rounded-2xl">
              <div className="flex flex-wrap gap-4">
                <button className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-zinc-950 px-6 py-3 text-white transition-all duration-300 hover:-translate-y-1 hover:border-red-500/40 hover:shadow-[0_10px_30px_rgba(239,68,68,0.25)]">
                  <img
                    src="https://images.shadcnspace.com/assets/svgs/icon-google.svg"
                    alt=""
                    className="h-5 w-5"
          ...
          <div className="rounded-xl w-100 h-100 mt-30 border border-solid border-white/30 bg-white p-1  shadow-input dark:bg-black md:rounded-2xl">
            <div className="rounded-xl w-fit bg-white p-1 mt-40 ml-30 shadow-input justify-center items-center dark:bg-black md:rounded-2xl">
              <div className="flex flex-wrap items-center justify-center gap-4">
                {/* GitHub */}
                <button className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-zinc-950 px-6 py-3 text-white transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/40 hover:shadow-[0_10px_30px_rgba(59,130,246,0.25)]">
                  <img
                    src="https://images.shadcnspace.com/assets/svgs/icon-linkedin.svg"
                    alt=""
                    className="h-5 w-5"
        ...
        <div className="gap-2 flex flex-2/3 ml-20 mb-20 mr-20 justify-between">
          ...
          <div className="rounded-xl w-100 h-100 mt-30 border border-solid border-white/30 bg-white p-1  shadow-input dark:bg-black md:rounded-2xl">
            <div className="rounded-xl w-fit bg-white p-1 mt-40 ml-32 shadow-input justify-center items-center dark:bg-black md:rounded-2xl">
              <div className="flex flex-wrap items-center justify-center gap-4">
                {/* LinkedIn */}
                <button className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-zinc-950 px-6 py-3 text-white transition-all duration-300 hover:-translate-y-1 hover:border-white/40 hover:shadow-[0_10px_30px_rgba(255,255,255,0.15)]">
                  <img
                    src="https://images.shadcnspace.com/assets/svgs/icon-github-white.svg"
                    alt=""
                    className="h-5 w-5"
          ...
          <div className="rounded-xl w-100 h-100 mt-30 border border-solid border-white/30 bg-black p-1   shadow-input md:rounded-2xl">
            <div className="rounded-xl w-fit mt-40 ml-20 shadow-input justify-center items-center dark:bg-black md:rounded-2xl">
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                <button
                  type="button"
                  className="flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-200 bg-white shadow-sm transition-all duration-300 hover:scale-110 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-950"
                >
                  <img
                    src="https://images.shadcnspace.com/assets/svgs/icon-google.svg"
                    alt="Google"
            ...
            <div className="rounded-xl w-fit bg-white p-1 mt-40 ml-15 shadow-input justify-center items-center dark:bg-black md:rounded-2xl">
              <div className="flex flex-wrap gap-4">
                {socials.map((social) => (
                  <button
                    key={social.name}
                    className="group relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-zinc-950 transition-all duration-300 hover:-translate-y-1 hover:scale-110 hover:shadow-[0_0_25px_rgba(255,255,255,0.15)]"
                  >
